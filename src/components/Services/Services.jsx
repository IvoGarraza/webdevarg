...
const Services = () => {
  return (
    <div id='services' className="h-[50rem] w-full flex flex-col items-center justify-center">
      <div className="w-full h-[20%] flex flex-col items-center justify-center ">
        <span className="text-2xl font-bold">Nuestros servicios</span>
        <span className="font-medium">Estos son algunos de los planes que ofrecemos</span>
      </div>
      <div className=" w-full flex flex-row justify-around py-6 h-[80%]">
        <div className="group shadow-lg hover:-mt-4 hover:mb-4 transition-all w-1/4 flex flex-col items-center justify-between bg-white rounded-md border-[1px] overflow-hidden border-slate-200">
        ...
        <div className="group shadow-lg hover:-mt-4 hover:mb-4 transition-all w-1/4 flex flex-col items-center justify-between bg-white rounded-md border-[1px] overflow-hidden border-slate-200">
          <span className="bg-black group-hover:bg-yellow-400 group-hover:text-black transition-all text-white w-full h-[10%] flex items-center justify-center font-semibold">
            Institucional
          </span>
          <p className="p-4 h-[70%] text-center">
